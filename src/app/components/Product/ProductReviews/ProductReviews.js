import CarouselBox from "../../Home/Customers/CarouselBox/CarouselBox";
    ...
    <div className={styles.product_reviews}>
      <div className={styles.product_reviews_header}>
        <div className={styles.product_header}>
          ...
          <p className={styles.reviews_number}>({count})</p>
        </div>
        <div className={styles.product_reviews_header_buttons}>
          ...
          <button className={styles.post_btn}>Write a Review</button>
        </div>
      </div>
      {isReviews ? (
        <>
          ...
          {count > 6 ? <button className={styles.more_reviews_btn}>Load More Reviews</button> : ""}
        </>
      ) : (
        <div className={styles.no_reviews_box}>
          <p className={styles.no_reviews_p}>This item is waiting for its first review.</p>
          <p className={styles.no_reviews_p}>
            Share your thoughts and help others find their perfect fit!
          </p>
        </div>
      )}
    </div>
