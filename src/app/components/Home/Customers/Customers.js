...
function Customers() {
  ...
  useEffect(() => {
    const commentsContainer = carouselContainer.current;
    ...
    if (commentsContainer) {
      commentsContainer.addEventListener("wheel", handleWheel);
    }
  ...
  return (
    <section className={styles.section_customers}>
      ...
      <div ref={carouselContainer} className={styles.carousel_container}>
        <div className={styles.carousel_box}>
          <div className={styles.customer_score}>
            ...
            >
              <path
                d="M11.4868 0L14.6852 6.8872L22.2237 7.80085L16.662 12.971L18.1226 20.4229L11.4868 16.731L4.85096 20.4229L6.31155 12.971L0.749813 7.80085L8.2883 6.8872L11.4868 0Z"
                fill="#FFC633"
              />
            </svg>
            <svg
          ...
          <div className={styles.customer_header}>
            <p className={styles.customer_name}>Alex K.</p>
            <svg
              width="24"
              height="25"
              viewBox="0 0 24 25"
          ...
          <p className={styles.customer_text}>
