import styles from "./ColorCircleSVG.module.css";

function ColorCircleSVG({ color_hex, isSelected }) {
  return (
    <>
      <svg
      ...
      >
        <circle
          ...
          cy="18.5"
          r="18.5"
          fill={`#${color_hex === "ffffff" ? "f8f8f8" : color_hex}`}
        />
      </svg>
      <svg
        className={`${styles.checkmark} ${isSelected ? styles.selectedCheckmark : ""}`}
        width="14"
        height="11"
        viewBox="0 0 14 11"
        fill="none"
      ...
      >
        <path
          ...
          fill={`#${color_hex === "ffffff" ? "000000" : "ffffff"}`}
        />
      </svg>
    </>
  );
